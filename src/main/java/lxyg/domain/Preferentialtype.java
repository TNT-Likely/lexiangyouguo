...
public class Preferentialtype  implements java.io.Serializable {
    ...
    /** full constructor */
    public Preferentialtype(Timestamp timeAdd, Timestamp timeUpdate, Float preferentialPercentage, Integer preferentialReducePrice, Integer preferentialArrivalIntegral) {
        this.timeAdd = timeAdd;
        this.timeUpdate = timeUpdate;
    ...
    public void setPreferentialArrivalIntegral(Integer preferentialArrivalIntegral) {
        this.preferentialArrivalIntegral = preferentialArrivalIntegral;
    }
