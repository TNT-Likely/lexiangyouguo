...
public class Commodityclassification  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Commodityclassification(Timestamp timeAdd, Timestamp timeUpdate, String classificationName) {
    ...
    /** full constructor */
    public Commodityclassification(Timestamp timeAdd, Timestamp timeUpdate, String classificationName, String classificationDiscript) {
        this.timeAdd = timeAdd;
        this.timeUpdate = timeUpdate;
        this.classificationName = classificationName;
