...
public class Emailserver  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Emailserver(Timestamp timeAdd, Timestamp timeUpdate, String esAccount, String password) {
    ...
    /** full constructor */
    public Emailserver(Timestamp timeAdd, Timestamp timeUpdate, String esEmailServer, String esSendMailService, String esAccount, String password, String esReplyEmaiAddressl, String esEmailAddress) {
        this.timeAdd = timeAdd;
        this.timeUpdate = timeUpdate;
    ...
    @Column(name="ES_Account", nullable=false, length=1024)
