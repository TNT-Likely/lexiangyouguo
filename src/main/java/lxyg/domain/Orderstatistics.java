...
public class Orderstatistics  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Orderstatistics(Timestamp timeAdd, Timestamp timeUpdate, String osGeneralSituation) {
    ...
    /** full constructor */
    public Orderstatistics(Integer ordId, Timestamp timeAdd, Timestamp timeUpdate, String osGeneralSituation, String osDistributionMethod, String osPaymentMethod, Double osEffectiveOrderAmount, Double osClickOrdersPerThousand, Double osClickMoneyPerThousand) {
        this.ordId = ordId;
        this.timeAdd = timeAdd;
        this.timeUpdate = timeUpdate;
        this.osGeneralSituation = osGeneralSituation;
