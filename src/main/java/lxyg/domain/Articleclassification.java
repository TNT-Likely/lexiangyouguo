 ...
 */
@Entity
@Table(name="articleclassification"
    ,catalog="lxyg"
)
...
public class Articleclassification  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Articleclassification(Timestamp timeAdd, Timestamp timeUpdate, String articleClassName) {
    ...
    /** full constructor */
    public Articleclassification(Timestamp timeAdd, Timestamp timeUpdate, String articleClassName, String articleClassStyle, String articleClassDescripetion, String articleClassWhetherNavigationBarDisplay, String articleClassSorting) {
        this.timeAdd = timeAdd;
        this.timeUpdate = timeUpdate;
        this.articleClassName = articleClassName;
    ...
    public void setArticleClassWhetherNavigationBarDisplay(String articleClassWhetherNavigationBarDisplay) {
        this.articleClassWhetherNavigationBarDisplay = articleClassWhetherNavigationBarDisplay;
    }
