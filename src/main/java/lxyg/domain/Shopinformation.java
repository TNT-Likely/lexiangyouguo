...
public class Shopinformation  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Shopinformation(Timestamp timeAdd, Timestamp timeUpdate, String shopInfoShopName) {
    ...
    /** full constructor */
    public Shopinformation(Timestamp timeAdd, Timestamp timeUpdate, String shopInfoShopName, String shopInfoShopLogo, String shopInfoStoreSlogan, String shopInfoStoreCopyright, String shopInfoStoreAuthoritativeAttestation) {
        this.timeAdd = timeAdd;
        this.timeUpdate = timeUpdate;
        this.shopInfoShopName = shopInfoShopName;
    ...
    public void setShopInfoStoreAuthoritativeAttestation(String shopInfoStoreAuthoritativeAttestation) {
        this.shopInfoStoreAuthoritativeAttestation = shopInfoStoreAuthoritativeAttestation;
    }
