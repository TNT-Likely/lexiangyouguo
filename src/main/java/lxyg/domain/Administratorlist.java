...
public class Administratorlist  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Administratorlist(Timestamp timeAdd, Timestamp timeUpdate, String administratoName, String password, Timestamp addTime, Timestamp administratoastLoginTime) {
    ...
    /** full constructor */
    public Administratorlist(Timestamp timeAdd, Timestamp timeUpdate, String administratoName, String password, String administratoSex, String administratoAddress, Timestamp addTime, Timestamp administratoastLoginTime) {
        this.timeAdd = timeAdd;
        this.timeUpdate = timeUpdate;
        this.administratoName = administratoName;
        this.password = password;
