 ...
 */
@Entity
@Table(name="harvestaddresstable"
    ,catalog="lxyg"
)
...
public class Harvestaddresstable  implements java.io.Serializable {
    ...
    /** full constructor */
    public Harvestaddresstable(Timestamp timeAdd, Timestamp timeUpdate, String haTheFirstAddress, String haTheSecondAddress, String haTheThirdAddress, String haTheFourthAddress) {
        this.timeAdd = timeAdd;
        this.timeUpdate = timeUpdate;
