		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="/Areas/Admin/Base/Index"> <img
					src="/shop/resources/admin/image/logo.png" alt="logo" /> 0
				</a>
				<!-- END LOGO -->
				<!-- BEGIN RESPONSIVE MENU TOGGLER -->
				<a href="javascript:;" class="btn-navbar collapsed"
					data-toggle="collapse" data-target=".nav-collapse"> <img
					src="/shop/resources/admin/image/menu-toggler.png" alt="" />
				</a>
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown" id="header_inbox_bar"><a href="#"
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li><a href="inbox.html?a=view"> <span class="photo"><img
										src="/shop/resources/admin/image/avatar2.jpg" alt="" /></span> <span
							...
							<li><a href="inbox.html?a=view"> <span class="photo"><img
										src=".//shop/resources/admin/image/avatar3.jpg" alt="" /></span> <span
							...
							<li><a href="inbox.html?a=view"> <span class="photo"><img
										src=".//shop/resources/admin/image/avatar1.jpg" alt="" /></span> <span
					...
					<li class="dropdown user"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> <img alt=""
							src="/shop/resources/admin/image/avatar1_small.jpg" /> <span
							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									...
									<div id="site_statistics_loading">
										...
										<img src="/shop/resources/admin//image/loading.gif"
											alt="loading" />
									...
									<div class="tools">
										...
										<div class="btn-group pull-right" data-toggle="buttons-radio">
											...
											<a href="" class="btn red mini active"> <span
												...
												class="visible-phone">DB</span>
											</a> <a href="" class="btn red mini">Web</a>
												...
												<div class="scroller" data-height="290px"
													...
													<div class="row-fluid">
														...
														<div class="span6 user-info">
															...
															<img alt="" src="/shop/resources/admin//image/avatar.png" />
									...
									<div class="scroller" data-height="435px"
										...
										<ul class="chats">
											...
											<li class="in"><img class="avatar" alt=""
												src="/shop/resources/admin//image/avatar1.jpg" />
											...
											<li class="out"><img class="avatar" alt=""
												src="/shop/resources/admin//image/avatar2.jpg" />
											...
											<li class="out"><img class="avatar" alt=""
												src="/shop/resources/admin//image/avatar3.jpg" />
									...
									<div class="chat-form">
										...
										<div class="btn-cont">
											...
											<span class="arrow"></span> <a href=""
												class="btn blue icn-only"><i class="icon-ok icon-white"></i></a>
