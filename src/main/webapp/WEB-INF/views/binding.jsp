...
<div class="header_2014">
    <div class="fm960 clearfix">
        <ul class="header_top">
                ...
                <ol class="ext_mode">
                    <li class="s2"><a href=" " class="site_publish_img">分享照片</a></li>
                    <li class="s2"><a href=" ">个人设置</a></li>
                    <li class="s2"><a href=" ">账号绑定</a></li>
                    <li class="s2"><a href="login.html">退出</a></li>
                </ol>
            </li>
            <li class="s1 has_icon has_line user_fav">
                <a href=" ">喜欢</a>
                <ul class="ext_mode">
                    <li class="s2"><a href=" ">关注的店铺</a></li>
                    <li class="s2"><a href=" ">浏览记录</a></li>
                </ul>
            </li>
...
<dl class="mu_nav">
    <dt>优惠特权</dt>
    <dd> <a href="huiyuandengji.html" target="_blank">钻石会员</a> </dd>
    <dd> <a href=" " target="_blank">先穿后付</a> </dd>
    <dd> <a href="wodejifen.html" >我的蘑豆</a> </dd>
    <dd> <a href=" ">现金券 </a> </dd>
    ...
    <dl class="mu_nav">
        ...
        <dd> <a href="/pay/wallet/home">钱包首页</a> </dd>
        <dd> <a href=" ">我的银行卡</a> </dd>
        <dd> <a href=" ">资金明细</a> </dd>
        <dd> <a href=" ">实名认证</a> </dd>
    </dl>
<dl class="mu_nav">
...
<dl class="mu_nav pb40">
    <dt>帐号设置</dt>
    <dd> <a href="jiben ziliao.html">基本信息</a> </dd>
    <dd> <a href="xiugaitouxiang.html">修改头像</a> </dd>
    <dd class="c"> <a href="bangding.html">帐号绑定</a> </dd>
    <dd> <a href="bangding.html">微信绑定</a> </dd>
    <dd> <a href=" ">个人封面</a> </dd>
    <dd> <a href=" ">个性域名</a> </dd>
    <dd> <a href=" ">黑名单</a> </dd>
</dl>
    ...
    <div class="settings_title">
        ...
        <div class="account_bind" id="setting_form">
        <div class="account_bind_title" >  绑定帐号可以把您的购物乐趣同步给更多好友。
         <a class="bind_help" target="_blank" href=" ">什么是绑定帐号，绑定帐号有什么用？</a></div>
        <ul class="bind_logo">
                            <li>
                    <div class="icon i_sina" ></div>
                    <div class="bind_web">
                        <p class="unbind">你的新浪微博(未绑定)</p>
                        <p class="bind_result"><a href=" " class="yellow_base_btn" ></a></p>
                    </div>
                </li>
                                        <li>
                <div class="icon i_tencent" ></div>
                <div class="bind_web">
                    <p class="unbind">你的腾讯微博(未绑定)</p>
                    <p class="bind_result"><a href=" " class="yellow_base_btn" ></a></p>
                </div>
            </li>
      <li >
                    <div class="icon i_qzone" ></div>
                    <div class="bind_web">
                        <p class="unbind">你的QQ空间帐号(未绑定)</p>
                        <p class="bind_result"><a href="" class="yellow_base_btn" ></a></p>
                    </div>
                </li>
             <li>
                    <div class="icon i_renren" ></div>
                    <div class="bind_web" id="bind_renren">
                        <p class="unbind">你的人人网帐号(未绑定)</p>
                        <p class="bind_result"><a href=" " class="yellow_base_btn" ></a></p>
                    </div>
                </li>
        </ul>
    ...
    <form action="" method="post" id="myform">
        ...
        <input type="hidden" name="secrect" id="secrect" value="" />
        <input type="hidden" name="follow_number" id="follow_number" value="" />
        <input type="hidden" name="fav_number" id="fav_number" value="" />
        <input type="hidden" name="bind_type" id="bind_type" value="" />
        <input type="hidden" name="expires_in" id="expires_in" value="" />
        <input type="hidden" name="refresh_token" id="refresh_token" value="" />
        <input type="hidden" name="errorbindmsg" id="errorbindmsg" value="" />
    </form>
...
<div class="foot J_footertimer" data-svrtime="1414139662">
    <div class="wrap foot_wrap clearfix">
        ...
        <div class="foot_link">
            ...
            <dl class="link_business">
                ...
                <dd><a href=" " target="_blank">入驻开放平台</a></dd>
            </dl>
            <dl class="link_safe">
                <dt>权威认证</dt>
                <dd>
